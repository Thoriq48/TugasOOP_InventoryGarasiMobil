 ...
 * @author Aharfi
 */
public class GUI_GarasiMobil extends javax.swing.JFrame {

    /**
     * Creates new form GUI_GarasiMobil
     */
    public GUI_GarasiMobil() {
        initComponents();
        DefaultTableModel dataModel = (DefaultTableModel) tableGarasi.getModel();
    ...
    private void initComponents() {
        ...
        tableGarasi = new javax.swing.JTable();
        ...
        jLabel1.setText("Data GudangMobil");
        ...
        tableGarasi.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "Type", "Merek", "Model", "Tahun Keluaran", "Jumlah Mobil"
            }
        ));
        jScrollPane2.setViewportView(tableGarasi);
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(txtType, javax.swing.GroupLayout.PREFERRED_SIZE, 186, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        tableGarasi.setAutoCreateColumnsFromModel(true);
        // Membuat instance dari kelas Mahasiswa
        Garasi mobil = new Garasi();
        mobil.dataType(txtType.getText());
        mobil.dataMerk(txtMerk.getText());
        mobil.dataModel(txtModel.getText());
        mobil.dataKeluaran(txtTahun.getText());
        mobil.dataJumlah(Integer.parseInt(txtJumlah.getText()));
        // Menambahkan data-data dari objek Mahasiswa ke dalam ArrayList 'list'
        list.add(mobil.cetakType());
        list.add(mobil.cetakMerk());
        list.add(mobil.cetakModel());
        list.add(mobil.cetakKeluaran());
        list.add(mobil.cetakJumlah());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUI_GarasiMobil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUI_GarasiMobil().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tableGarasi;
